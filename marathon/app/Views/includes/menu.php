...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        ...
        <li
            <?php
            if (isset($manage_marathon)) { echo ' class="active"'; }
            ?>
        >
        ...
        <li
            <?php
            if (isset($add_marathon)) { echo ' class="active"'; }
            ?>
        >
        ...
        <li
            <?php
            if (isset($manage_runners)) { echo ' class="active"'; }
            ?>
        >
        ...
        <li
            <?php
            if (isset($registration_form)) { echo ' class="active"'; }
            ?>
        >
